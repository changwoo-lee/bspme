...
|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| [`blm_me()`](https://changwoo-lee.github.io/bspme/reference/blm_me.md)           | Bayesian linear regression models with spatial exposure measurement error.  |
| [`bglm_me()`](https://changwoo-lee.github.io/bspme/reference/bglm_me.md)         | Bayesian generalized linear models with spatial exposure measurement error. |
| [`vecchia_cov()`](https://changwoo-lee.github.io/bspme/reference/vecchia_cov.md) | Run Vecchia approximation given a covariance matrix.                        |
