...
#' @param family *class \link[stats]{family}*, a description of the error distribution and the link function to be used in the model. Currently, it only supports binomial(link = "logit").
